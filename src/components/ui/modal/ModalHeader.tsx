  ...
  return (
    <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 bg-white dark:bg-black border-b border-zinc-200/50 dark:border-white/[0.05]">
      ...
      {showCloseButton && onClose && (
        <button
          onClick={onClose}
          className="p-2 -mr-2 text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-xl transition-all active:scale-90"
          aria-label="Tutup"
        >
          <X className="w-4 h-4" />
        </button>
