    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-slate-50 p-4">
        ...
        >
          ...
          <button
            onClick={handleLogin}
            className="w-full py-4 rounded-xl bg-card border-2 border-slate-100 font-bold text-slate-700 flex items-center justify-center gap-3 hover:bg-slate-50 hover:border-blue-200 transition-all active:scale-95 shadow-sm"
          >
