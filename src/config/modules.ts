...
export const DEFAULT_MODULES: Record<string, ModuleConfig> = {
  home: {
    ...
    allowedRoles: [ROLES.OWNER, ROLES.ADMIN, ROLES.ADMIN_CABANG, ROLES.SALES, ROLES.SURVEY, ROLES.GUDANG, ROLES.SPV],
    allowedBranches: [],
    betaMode: false,
  ...
  client: {
    ...
    visibleInWorkspace: true,
    defaultWorkspaceEligible: true,
    allowedRoles: [ROLES.OWNER, ROLES.ADMIN, ROLES.ADMIN_CABANG, ROLES.SALES, ROLES.SURVEY, ROLES.SPV],
    allowedBranches: [],
    betaMode: false,
    maintenanceMode: false,
  },
  ...
  marketPlans: {
    ...
    visibleInWorkspace: true,
    defaultWorkspaceEligible: true,
    allowedRoles: [ROLES.OWNER, ROLES.ADMIN, ROLES.ADMIN_CABANG, ROLES.SALES, ROLES.SPV],
    allowedBranches: [],
    betaMode: false,
    maintenanceMode: false,
  },
  report: {
    ...
    allowedRoles: [ROLES.OWNER, ROLES.ADMIN, ROLES.ADMIN_CABANG, ROLES.SPV],
    allowedBranches: [],
    betaMode: false,
    maintenanceMode: false,
  },
  ...
  timeline: {
    ...
    visibleInWorkspace: true,
    defaultWorkspaceEligible: false,
    allowedRoles: [ROLES.OWNER, ROLES.ADMIN, ROLES.ADMIN_CABANG, ROLES.SPV, ROLES.SALES],
    allowedBranches: [],
    betaMode: false,
    maintenanceMode: false,
  },
